...
public class MediatorTests
{
    ...
    public void CategoryByIdQuery()
    {
        ...
        Assert.IsTrue(response.Succeeded && response.Value != default);
    }
    ...
    public void InsertCategoryCommand()
    {
        ...
        Assert.IsTrue(response.Succeeded && response.Value > 0);
    }
...
{
    public Task<Result<long>> HandleAsync(InsertCategoryCommand request)
    {
...
public sealed class UpdateCategoryCommandHandler : IHandler<UpdateCategoryCommand>
{
    ...
    public async Task<Result> HandleAsync(UpdateCategoryCommand request)
    {
...
{
    public Task<Result> HandleAsync(UpdatedCategoryEvent request)
    {
